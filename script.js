...
function movimentaPeca(peca, casa) {
    ...
    const novaPeca = document.createElement("i");
    novaPeca.classList.add(peca.classList[0], peca.classList[1], peca.classList[2], peca.classList[3], peca.classList[4]);

    colunaDisponivel.appendChild(novaPeca);
    adicionaFuncoesAPeca(novaPeca);
    peca.remove();
    limpaCasasDisponiveis();
}

function adicionaFuncoesAPeca(peca) {
